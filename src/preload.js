...
contextBridge.exposeInMainWorld('rgbCentral', {
  ...
  discoverGovee: () => ipcRenderer.invoke('discover-govee'),
  configureGovee: (deviceIds) => ipcRenderer.invoke('configure-govee', deviceIds),
  configureAmbientLight: (settings) => ipcRenderer.invoke('configure-ambient-light', settings),
